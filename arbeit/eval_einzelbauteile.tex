\subsection{Evaluation Einzelkomponenten}\label{evalutation_small_components}
...
\subsubsection{ext. Netzteil}\label{ext_supply}
...
Mittels Stifleisten soll auch die Möglichkeit bestehen, aus einer anderen Quelle ein TDM-Signal einspeisen zu können. Ob und wie sehr diese Stiftleiste HF-mässig eine Störung hervorruft oder gar als Antenne wirkt musste noch eruiert werden.
\subsubsection{Testsignale}
Zur Fehlersuche wurden einige Stiftleisten mit Speisungsleitungen, Ein- und Ausgängen vorgesehen.
\subsubsection{ext. Modul}
Damit in Zukunft evtl. auch die Anbindung anderer TDM-Module möglich ist, wurden I2C- und TDM-Leitungen und 5V- und 3V-Leitungen auf eine eigene Stiftleiste geführt.
