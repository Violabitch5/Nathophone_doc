...
\newfontfamily\letterspaced{FiraSans}[LetterSpace=5]
...
\begin{titlepage}
	...
	\begin{center}
		...
		% Title
		{\letterspaced \huge \textbf{Design und Herstellung eines Beam Steering-fähigen Saiteninstruments}} 			\\ [0.5cm]
		{\Large Nathanael Gubler}\\TS TSE 2302 A\\ \vspace{3cm}
		\includegraphics[width=6.0cm]{./pictures/JuventusLogo.pdf}\\\vspace{-7mm}www.technikerschule.ch\\\vspace{4cm}
