...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth*7/8}{>{\hsize=.35\hsize}XX}
		...
		SDIN & Datenleitung. Daten können ab dem \textbf{zweiten} Clock mit dem MSB beginnen (I2S Format), oder ab dem \textbf{ersten} Clock mit dem MSB (Left-Justified), oder so dass das LSB immer auf den letzten Clock fällt (Right-Justified)\\\midrule
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth - 5cm]{pictures/Sample_rates_TAS5720.png}
